...
@section('title', 'About Us - HealthyBotic')
@section('SupUserContent')
    ...
    <div class="col-md-12 m-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('supuser.settingsAboutUsUpdate') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="col-md-12 m-auto">
        <div class="card">
            <div class="card-title text-center">
                <h4>Preview About Page</h4>
            </div>
            <div class="card-body">
                {!! $previewAbout->description !!}
            </div>
        </div>
    </div>
