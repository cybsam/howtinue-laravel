  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('blogusr.dashboard') }}" class="logo d-flex align-items-center">
            ...
            @endphp
              ...
              <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                  <li class="dropdown-header">
                      ...
                      <a href="{{ route('blogusr.ShowContact') }}"><span class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
                  </li>
                  <li>
                      <hr class="dropdown-divider">
                  </li>
                  ...
                  <li class="message-item">
                      <a href="{{ route('blogusr.ShowContactShow',['message_id'=>$fetchMsg->id]) }}">
                  ...
                  <li class="dropdown-footer">
                      <a href="{{ route('blogusr.ShowContact') }}">Show all messages</a>
                  </li>
